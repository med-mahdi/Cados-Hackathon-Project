...
app.component('hero-profile-card',{
    template:
    /* html */
    `
    <div class="background-image">
        <img src="./icon/backgroundImage1.jpg" alt="">
    </div>
    <div class="profile-info-header">
        <div class="profile-image-user">
            <img src="https://dennisivy-personal.s3.amazonaws.com/shanselman-cado.jpg" alt="">
        </div>

        <div class="profile-info-data">
            <div class="profile-name-follow">
                <h1>Gabrial Dennis</h1>
                <p><b>306310</b> followers</p>
            </div>

            <h2>gabrial dennis fransco</h2>
            <p class="bio">Advocate developer at Agora Company</p>
        ...
        <div class="profile-follow-btns">
            <button class="more-btn">. . .</button>
            <button class="send-msg-btn">
                <img src="" alt="" id="icon-send-msg">
                Send message
            </button>
